...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
              KC_ESCAPE,            KC_1,            KC_2,            KC_3,
                   KC_4,            KC_5,            KC_6,            KC_7,
                   KC_8,            KC_9,            KC_0,    KC_BACKSLASH,
              KC_DELETE,          KC_TAB,            KC_Q,            KC_W,
                   KC_E,            KC_R,            KC_T,            KC_Y,
                   KC_U,            KC_I,            KC_O,            KC_P,
               KC_QUOTE,        KC_GRAVE,    KC_LEFT_CTRL,            KC_A,
                   KC_S,            KC_D,            KC_F,            KC_G,
             KC_PAGE_UP,            KC_H,            KC_J,            KC_K,
                   KC_L,        KC_MINUS,        KC_ENTER,   KC_LEFT_SHIFT,
                   KC_Z,            KC_X,            KC_C,            KC_V,
                   KC_B,    KC_PAGE_DOWN,            KC_N,            KC_M,
               KC_COMMA,          KC_DOT,           KC_UP,        KC_SLASH,
            KC_LEFT_ALT,     KC_LEFT_GUI,           MO(1),        KC_SPACE,
          KC_LANGUAGE_2, KC_PRINT_SCREEN,   KC_LANGUAGE_1,    KC_BACKSPACE,
                  MO(2),         KC_LEFT,         KC_DOWN,        KC_RIGHT
    ),
    [1] = LAYOUT(
         KC_TRANSPARENT,           KC_F1,           KC_F2,           KC_F3,
                  KC_F4,           KC_F5,           KC_F6,           KC_F7,
                  KC_F8,           KC_F9,          KC_F10,          KC_F11,
                 KC_F12,  KC_TRANSPARENT,           KC_NO,           KC_NO,
